...
func Deprecations(name string) (bool, string, string) {
	...
	case "efk":
		return true, "", "The current images used in the efk addon contain Log4j vulnerabilities, the addon will be disabled until images are updated, see: https://github.com/nholuongut/minikube/issues/15280"
	}
	return false, "", ""
}
