...
func TestDownloadURL(t *testing.T) {
	const urlBase = "https://github.com/nholuongut/minikube/releases/download/"
	type args struct {
		ver  string
		os   string
		arch string
	...
	tests := []struct {
		...
		{"linux-unset", args{"foo-unset", "linux", "amd64"}, "https://github.com/nholuongut/minikube/releases"},
		{"linux-unset", args{"foo-unset", "windows", "arm64"}, "https://github.com/nholuongut/minikube/releases"},
