...
* Documentation: example.com
* Related issues:
  - https://github.com/nholuongut/minikube/issues/0
  - https://github.com/nholuongut/minikube/issues/1
`,
		},
		{
...
func TestDisplayProblemJSON(t *testing.T) {
	...
	tcs := []struct {
	...
	}{
		{
			...
			expected: `{"data":{"advice":"fix me!","exitcode":"4","issues":"https://github.com/nholuongut/minikube/issues/1,https://github.com/nholuongut/minikube/issues/2","message":"my error","name":"BUG","url":"url"},"datacontenttype":"application/json","id":"random-id","source":"https://minikube.sigs.k8s.io/","specversion":"1.0","type":"io.k8s.sigs.minikube.error"}
`,
		},
	}
	for _, tc := range tcs {
