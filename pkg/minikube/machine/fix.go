...
// because docker changes the allocated bind ports after restart https://github.com/nholuongut/minikube/issues/6824
func maybeWarnAboutEvalEnv(drver string, name string) {
	...
	if os.Getenv(constants.MinikubeActiveDockerdEnv) != "" {
		...
		// TODO: refactor docker-env package to generate only eval command per shell. https://github.com/nholuongut/minikube/issues/6887
	...
	if os.Getenv(constants.MinikubeActivePodmanEnv) != "" {
		...
		// TODO: refactor podman-env package to generate only eval command per shell. https://github.com/nholuongut/minikube/issues/6887
