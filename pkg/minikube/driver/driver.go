...
var (
	// systemdResolvConf is path to systemd's DNS configuration. https://github.com/nholuongut/minikube/issues/3511
...
// KIC also needs shutdown to avoid container getting stuck, https://github.com/nholuongut/minikube/issues/7657
