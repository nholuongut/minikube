...
MINIKUBE_RELEASES_URL=https://github.com/nholuongut/minikube/releases/download
...
html_report: ## Generate HTML  report out of the last ran integration test logs.
	...
	@gopogh -in "./out/testout_$(COMMIT_SHORT).json" -out ./out/testout_$(COMMIT_SHORT).html -name "$(shell git rev-parse --abbrev-ref HEAD)" -pr "" -repo github.com/nholuongut/minikube/  -details "${COMMIT_SHORT}"
