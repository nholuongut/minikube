...
name: minikube
version: ${version}
website_url: https://github.com/nholuongut/minikube
repo_url: https://github.com/nholuongut/minikube
documentation_url: https://minikube.sigs.k8s.io/docs/
product_logo_url: https://raw.githubusercontent.com/nholuongut/minikube/master/images/logo/logo.svg
type: installer
