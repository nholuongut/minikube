...
func validateMountCmd(ctx context.Context, t *testing.T, profile string) { // nolint
	...
	if HyperVDriver() {
		t.Skip("skipping: mount broken on hyperv: https://github.com/nholuongut/minikube/issues/5029")
	}
	if RootlessDriver() {
	...
	if runtime.GOOS == "windows" {
		t.Skip("skipping: mount broken on windows: https://github.com/nholuongut/minikube/issues/8303")
	}
