...
func validateImageBuildWithBuildArg(ctx context.Context, t *testing.T, profile string) {
	// test case for bug in https://github.com/nholuongut/minikube/issues/12384
	defer PostMortemLogs(t, profile)
...
func validateImageBuildWithBuildEnv(ctx context.Context, t *testing.T, profile string) {
	...
	// current this test cannot be passed because issue https://github.com/nholuongut/minikube/issues/12431 hasn't been fixed, so this test case is not enabled
	t.Skip("skipping due to https://github.com/nholuongut/minikube/issues/12431")
