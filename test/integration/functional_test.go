...
func validateDryRun(ctx context.Context, t *testing.T, profile string) {
	...
	if rr.ExitCode != wantCode {
		if HyperVDriver() {
			t.Skip("skipping this error on HyperV till this issue is solved https://github.com/nholuongut/minikube/issues/9785")
		} else {
...
func validateServiceCmdConnect(ctx context.Context, t *testing.T, profile string) {
	...
	if NeedsPortForward() {
		t.Skipf("test is broken for port-forwarded drivers: https://github.com/nholuongut/minikube/issues/7383")
	}
...
func validateMySQL(ctx context.Context, t *testing.T, profile string) {
	...
	if arm64Platform() {
		t.Skip("arm64 is not supported by mysql. Skip the test. See https://github.com/nholuongut/minikube/issues/10144")
	}
