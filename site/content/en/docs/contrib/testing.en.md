...
- Go distribution
  ...
  - The current dependency version can be found here : [master branch's go.mod file](https://github.com/nholuongut/minikube/blob/master/go.mod).
...
See [main_test.go](https://github.com/nholuongut/minikube/blob/master/test/integration/main_test.go) for details.
...
Clone the [minikube repo](https://github.com/nholuongut/minikube)
