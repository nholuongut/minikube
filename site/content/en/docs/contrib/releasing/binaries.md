...
Make appropriate changes to [SECURITY-INSIGHTS.yml](https://github.com/nholuongut/minikube/SECURITY-INSIGHTS.yml). Check [OPENSSF Security Insights Specification](https://github.com/ossf/security-insights-spec/blob/main/specification.md) for reference.

## Announce

Please mention the new release https://github.com/nholuongut/minikube/blob/master/README.md
