...
- The following Docker runtime security options are currently *unsupported and will not work* with the Docker driver (see [#9607](https://github.com/nholuongut/minikube/issues/9607)):
...
- The `ingress`, and `ingress-dns` addons are currently only supported on Linux. See [#7332](https://github.com/nholuongut/minikube/issues/7332)

- On WSL2 (experimental - see [#5392](https://github.com/nholuongut/minikube/issues/5392)), you may need to run:

   `sudo mkdir /sys/fs/cgroup/systemd && sudo mount -t cgroup -o none,name=systemd cgroup /sys/fs/cgroup/systemd`.

Also see [co/docker-driver open issues](https://github.com/nholuongut/minikube/labels/co%2Fdocker-driver).
...
- On Linux, if you want to run MySQL pod, you need to disable AppArmor for mysql profile
   ...
   If your docker has [AppArmor](https://wiki.ubuntu.com/AppArmor) enabled, running mysql in privileged mode with docker driver will have the issue [#7401](https://github.com/nholuongut/minikube/issues/7401).
