...
<script language="javascript">
  ...
  fetch('https://api.github.com/repos/nholuongut/minikube/releases')
...
Click on the buttons that describe your target platform. For other architectures, see [the release page](https://github.com/nholuongut/minikube/releases/latest) for a complete list of minikube binaries.
...
```shell
r=https://api.github.com/repos/nholuongut/minikube/releases
...
<br>
    ...
    Invoke-WebRequest -OutFile 'c:\minikube\minikube.exe' -Uri 'https://github.com/nholuongut/minikube/releases/latest/download/minikube-windows-amd64.exe' -UseBasicParsing
    ```
...
<br>
    ...
    ```powershell
    New-Item -Path 'c:\' -Name 'minikube' -ItemType Directory -Force
    $response = Invoke-WebRequest -Uri 'https://api.github.com/repos/nholuongut/minikube/releases' -UseBasicParsing
...
<script type="text/javascript">
  fetch("https://api.github.com/repos/nholuongut/minikube/releases")
    ...
    .catch((error) => {
      ...
      el.href = "https://github.com/nholuongut/minikube/releases";
    });
</script>
{{% /quiz_instruction %}}
